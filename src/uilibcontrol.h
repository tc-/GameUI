...
namespace Ui
{
	...
	class LibControl : public has_slots<>
	{
		public:
			...
			virtual bool handleKeyboardEvents() {
				return pHandleKeyboard;
			}
			virtual bool handleMouseEvents() {
				return pHandleMouse;
			}
			virtual bool handleSysEvents() {
				return pHandleSys;
			}
			virtual bool handleTimers() {
				return pHandleTimers;
			}
			virtual void setHandleKeyboardEvents( const bool& handle = true ) {
				pHandleKeyboard = handle;
			}
			virtual void setHandleMouseEvents( const bool& handle = true ) {
				pHandleMouse = handle;
			}
			virtual void setHandleSysEvents( const bool& handle = true ) {
				pHandleSys = handle;
			}
			virtual void setHandleTimers( const bool& handle = true ) {
